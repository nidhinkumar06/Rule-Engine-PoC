...
import { FlowchartConstants, FcModel, UserCallbacks, NgxFlowchartComponent, FcNode } from 'ngx-flowchart-dev';
import { of } from 'rxjs';
import { DELETE } from '@angular/cdk/keycodes';
import { ENRICHMENT_NODE_DATA } from '../../constants/constants';
import { RulesserviceService } from './rulesservice.service';
...
@Component({
  ...
  templateUrl: './rulepage.component.html',
  styleUrls: ['./rulepage.component.scss']
})
export class RulepageComponent implements  OnInit, AfterViewInit {
